...
QOI_sk is the QOI compatible format for fast, lossless image compression
Single-file MIT licensed library for C/C++

See [qoi_sk.h](https://github.com/skandau/qoi_sk/blob/master/qoi_sk.h) for
...
3x-4x faster decoding and 10% better compression than original QOI. It's also stupidly simple and
fits in about 300 lines of C.


## Example Usage

- [qoiconv.c](https://github.com/skandau/qoi_sk/blob/master/qoiconv.c)
